    ...
    <div className="relative min-h-screen">
      ...
      <main className="relative mx-auto max-w-4xl px-5 pb-24 pt-12 sm:px-6">
        <div className="mb-10">
          ...
          <h1 className="mt-4 text-balance text-[30px] font-bold leading-tight tracking-[-0.025em] text-graphite sm:text-[38px]">
        ...
        {reports.length === 0 ? (
          <div className="card-luxe rounded-card-lg p-10 text-center">
            <span className="mx-auto grid h-14 w-14 place-items-center rounded-full bg-mist text-quiet">
              <FileText className="h-6 w-6" />
            </span>
            <h2 className="mt-5 text-[19px] font-bold tracking-tight text-graphite">
              Nothing here yet
            </h2>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <p className="truncate text-[13.5px] font-semibold text-graphite">{r.fileName}</p>
                    ...
                    <ArrowRight className="h-4 w-4 shrink-0 text-quiet transition-transform group-hover:translate-x-0.5" />
                  </div>
                  <div className="mt-4 flex items-center justify-between rounded-2xl bg-mist/70 px-4 py-3">
                    <div>
                      <p className="text-[10.5px] font-medium text-quiet">Kept</p>
                      <p className={`text-[15px] font-bold tabular-nums ${r.net >= 0 ? "text-graphite" : "text-risk"}`}>
                        {r.currency} {Math.round(r.net).toLocaleString()}
                      </p>
                    </div>
                    <div className="text-right">
                      <p className="text-[10.5px] font-medium text-quiet">Savings rate</p>
