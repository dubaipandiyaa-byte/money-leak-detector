        ...
        {checkEmail ? (
          <div className="card-luxe rounded-card-lg p-8 text-center">
            ...
            <p className="mt-3 text-[14.5px] leading-relaxed text-slate-ink">
              ...
              <strong className="font-semibold text-graphite">{checkEmail}</strong>. Click it to
          ...
          <>
            <div className="mb-8 text-center">
              <p className="eyebrow">Free forever plan</p>
            ...
            <div className="card-luxe rounded-card-lg p-6 sm:p-8">
              ...
              <form action={signup} className="space-y-4">
                ...
                <p className="text-center text-[12px] leading-relaxed text-quiet">
                  By continuing you agree to our{" "}
                  <Link href="/terms" className="font-semibold text-emerald-600 underline-offset-2 hover:underline">
                    Terms
                  </Link>{" "}
                  and{" "}
                  <Link href="/privacy" className="font-semibold text-emerald-600 underline-offset-2 hover:underline">
                    Privacy Policy
                  </Link>
                  .
                </p>
