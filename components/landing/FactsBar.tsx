  ...
  return (
    <section className="border-y border-[rgba(212,175,55,0.14)] bg-noir-deep">
      <Reveal blur={false} y={14}>
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-y-2 px-6 py-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-y-0 lg:divide-x lg:divide-white/5 lg:py-0">
          {facts.map((f) => (
            <div key={f.value} className="flex items-center gap-4 px-2 py-3 sm:px-4 lg:px-8 lg:py-7">
