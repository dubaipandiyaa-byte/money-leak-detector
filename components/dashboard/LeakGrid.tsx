    ...
    <section aria-label="Active leaks">
      <Reveal blur={false} y={14}>
        <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
          <div>
            <h2 className="text-[20px] font-bold tracking-tight text-ivory">
              Active Leaks
            </h2>
            <p className="mt-0.5 text-[13.5px] text-ash">
              From your latest report — each one a real recurring or duplicate charge.
            </p>
          </div>
          <Link
            href="/history"
            className="rounded-full bg-white/[0.06] px-4 py-2 text-[12.5px] font-semibold text-ivory shadow-float ring-1 ring-white/10 transition-colors hover:bg-mist"
          >
            View full report →
          </Link>
        </div>
      ...
      {top.length === 0 ? (
        <div className="card-luxe rounded-card-lg p-8 text-center text-[14px] text-ash">
